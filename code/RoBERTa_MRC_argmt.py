...
class Main(object):
    ...
    def train(self):
        ...
        for thresh in [0.45, 0.5, 0.55, 0.6, 0.65, 0.7]:
...
if __name__ == "__main__":
    ...
    with open("../user_data/tmp_data/process_argmt.pkl", "rb") as f:
        x = pickle.load(f)
    ...
    if sys.argv[1] == "train":
        ...
        train_dataset = MyDataset(data=x["train_items_1"], max_enc_len=args["max_enc_len"])
