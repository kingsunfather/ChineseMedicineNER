...
class MyModel(nn.Module):
    ...
    def forward(self, input_ids, input_mask, input_seg, bie_label, start_label=None, end_label=None, seq_mask=None):
        ...
        if start_label is None or end_label is None or seq_mask is None:
            ...
            # 加权损失和标签平滑
            weight = torch.tensor([0.5, 1.5], device=input_ids.device) if args["weighted_loss"] else None
...
class Main(object):
    def __init__(self, train_loader, valid_loader, test_flag=False, test_loader=None, pretrain=False):
        ...
        self.vocab = {line.strip() for line in open('vocab.txt', encoding="UTF-8").readlines()}
...
if __name__ == "__main__":
    ...
    args = {
        ...
        "min_lr_rate": 1e-8,
        "eval_interval": 200,
        "save_path": "../user_data/model_data/best_score_wl.pth",
    ...
    if sys.argv[1] == "train":
        ...
        torch.distributed.init_process_group(backend="nccl", rank=0, world_size=1, init_method='tcp://localhost:6671')
        args["is_train"] = True
